...
def create_dataset(cfg: CfgNode):
    ...
    if cfg.dataset == "breakfast":
        map_fname = BASE + 'data_i3d/breakfast/mapping.txt'
        dataset_path = BASE + 'data_i3d/breakfast/'
        train_split_fname = BASE + f'data_i3d/breakfast/splits/train.{cfg.split}.bundle'
        test_split_fname = BASE + f'data_i3d/breakfast/splits/test.{cfg.split}.bundle'
        feature_path = BASE + 'data_i3d/breakfast/features'
        ...
        map_fname = BASE + 'data_i3d/gtea/mapping.txt'
        dataset_path = BASE + 'data_i3d/gtea/'
        feature_path = BASE + 'data_i3d/gtea/features/'
        train_split_fname = BASE + f'data_i3d/gtea/splits/train.{cfg.split}.bundle'
        test_split_fname = BASE + f'data_i3d/gtea/splits/test.{cfg.split}.bundle'
        feature_transpose = True
        if cfg.Loss.match == 'o2o':
