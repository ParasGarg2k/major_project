...
def func_eval(dataset, recog_path, file_list):
    ground_truth_path = "/home/cair/Dharmendra/ASFormer-main/data/ground_truth_8fps/"
    mapping_file = "/home/cair/Dharmendra/ASFormer-main/mapping.txt"
...
def main():
    ...
    dataset = 'gtea'
    split = '1'
    result_dir = "results3/"+dataset+"/split_"+split
    ...
    if split == 0:
        for split in range(1, cnt_split_dict[dataset] + 1):
            recog_path = "./{}/".format(result_dir)+dataset+"/split_{}".format(split)+"/"
            file_list = "/home/cair/Dharmendra/ASFormer-main/data/splits2/test.split1.bundle"
            acc, edit, f1s = func_eval(dataset, recog_path, file_list)
            acc_all += acc
            edit_all += edit
            f1s_all[0] += f1s[0]
            f1s_all[1] += f1s[1]
        ...
        acc_all /=  cnt_split_dict[dataset]
        edit_all /= cnt_split_dict[dataset]
        f1s_all = [i / cnt_split_dict[dataset] for i in f1s_all]
    else:
        split = split
        recog_path = "/home/cair/Dharmendra/ASFormer-main/results3/"+dataset+"/split_"+split+"/"
        file_list = "/home/cair/Dharmendra/ASFormer-main/data/splits2/test.split1.bundle"
        acc_all, edit_all, f1s_all = func_eval(dataset, recog_path, file_list)
